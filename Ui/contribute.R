...
fluidPage(
  ...
  p("Please use the add data function to add additional rows to the table. Once you have finished, download the data and email it to P.Benaud@exeter.ac.uk or submit it as a pull-request on the SoilErosionMap github page."),
