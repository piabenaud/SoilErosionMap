...
# Pop up for data entry ---------------------------------------------------
  ...
  observeEvent(input$Add_row_head, {
    ...
    showModal(modalDialog(title = "Add a new erosion observation",
                          ...
                          textInput(paste0("Country_add", input$Add_row_head), "Country:", value = "NA"),
                          h4("Study Dates"),
                          ...
                          numericInput(paste0("slope_add", input$Add_row_head), "Slope gradient (%):", NA),
...
# Add the new data to the datatable ---------------------------------------
  ...
  observeEvent(input$go, {
    new_row <- tibble(
      ...
      "Latitude" = input[[paste0("Lat_add", input$Add_row_head)]],
      "Country" = input[[paste0("Country_add", input$Add_row_head)]],
      ...
      "Slope_gradient" = input[[paste0("slope_add", input$Add_row_head)]],
